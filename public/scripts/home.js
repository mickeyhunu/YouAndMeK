...
const S=[{label:"홈",href:"#home"},{label:"소개",href:"#about"},{label:"가격",href:"#price"},{label:"실시간",href:"#live-info"},{label:"시설",href:"#facility"},{label:"이벤트",href:"#events"},{label:"후기",href:"#reviews"},{label:"FAQ",href:"#faq"},{label:"오시는 길",href:"#location"}],
...
f.jsxs("div",{"data-loc":"client/src/pages/Home.tsx:478",className:"flex items-center justify-between",children:[f.jsx("span",{"data-loc":"client/src/pages/Home.tsx:479",className:"text-gray-300 font-semibold text-lg",children:"▶ TC" }),
f.jsx("span",{"data-loc":"client/src/pages/Home.tsx:480",className:"text-3xl font-black",style:{color:"#f5e27a"},children:"12만원"})] }),
f.jsx("p",{"data-loc":"client/src/pages/Home.tsx:482",className:"text-sm text-gray-500 text-center pt-2",style:{borderTop:"1px solid rgba(201,168,76,0.1)"},children:"맥주+과일 포함"})]})]})})] }),
...
function SignalStyles(){return f.jsx("style",{children:`.youandme-signal-wrap{background:linear-gradient(180deg,#030e09,#020b06);padding:80px 16px;color:#f5e27a;font-family:'Noto Sans KR',system-ui,sans-serif}.youandme-signal-wrap .signal-inner{max-width:1180px;margin:0 auto}.youandme-signal-wrap .section-label{letter-spacing:.28em;text-transform:uppercase;color:rgba(201,168,76,.75);font-size:12px;text-align:center;margin:0 0 12px}.youandme-signal-wrap h2{font-family:'Noto Serif KR',serif;font-size:clamp(28px,5vw,48px);text-align:center;margin:0 0 16px;color:#f5e27a}.youandme-signal-wrap .section-desc{max-width:760px;margin:0 auto 28px;text-align:center;color:rgba(255,255,255,.72);line-height:1.8}.live-info-status,.community-review-status{margin:0 auto 24px;max-width:720px;text-align:center;color:rgba(255,255,255,.68)}.is-hidden{display:none!important}.live-info-cta{text-align:center;margin-bottom:28px}.live-info-link,.community-review-more{color:#f5e27a;text-decoration:none}.live-info-link:hover,.community-review-more:hover{text-decoration:underline}.live-info-grid,.review-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:18px}.live-card,.rv{background:rgba(3,18,10,.86);border:1px solid rgba(201,168,76,.22);border-radius:18px;padding:22px;box-shadow:0 18px 48px rgba(0,0,0,.24)}.live-card-head{display:flex;justify-content:space-between;gap:16px;align-items:flex-start;margin-bottom:18px}.live-card-label{margin:0 0 4px;color:rgba(201,168,76,.65);font-size:12px;letter-spacing:.18em}.live-card h3{margin:0;color:#fff;font-size:20px}.live-pill{font-size:12px;color:#f5e27a;border:1px solid rgba(201,168,76,.28);border-radius:999px;padding:6px 10px;white-space:nowrap}.live-metrics{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:18px}.live-metric{border:1px solid rgba(201,168,76,.16);border-radius:14px;padding:16px;text-align:center;background:rgba(255,255,255,.03)}.live-metric-value{display:block;font-size:32px;font-weight:900;color:#f5e27a}.live-metric-value.is-relaxed{font-size:28px}.live-metric-label{font-size:12px;color:rgba(255,255,255,.6)}.room-floor{margin-top:12px}.room-floor-title{margin:0 0 8px;color:#f5e27a}.room-type-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.room-type,.entry-chip{display:flex;justify-content:space-between;gap:10px;border-radius:999px;background:rgba(255,255,255,.06);border:1px solid rgba(201,168,76,.12);padding:8px 12px;color:rgba(255,255,255,.82)}.entry-list{display:flex;flex-wrap:wrap;gap:8px}.entry-chip{display:inline-flex}.live-empty{color:rgba(255,255,255,.58);margin:0}.community-review-card{cursor:pointer;color:rgba(255,255,255,.76)}.community-review-date{margin:0 0 10px;color:rgba(201,168,76,.72);font-size:12px}.community-review-title{margin:0 0 10px;color:#fff;font-size:18px}.community-review-content{line-height:1.7;display:-webkit-box;-webkit-line-clamp:3;-webkit-box-orient:vertical;overflow:hidden}`})}
function $b(){return f.jsx("section",{className:"youandme-signal-wrap live-info",id:"live-info","aria-labelledby":"live-info-h2",dangerouslySetInnerHTML:{__html:`<div class="signal-inner"><p class="section-label">Live Signal</p><h2 id="live-info-h2">유앤미 실시간 가게정보</h2><p class="section-desc">유앤미출근부, 유앤미엔트리, 유앤미웨이팅, 유앤미초이스톡처럼 예약 전 필요한 핵심 정보를 한곳에서 확인할 수 있습니다.
실시간 룸 현황과 오늘 출근부는 참고용 정보이며, 현장 상황은 변동될 수 있으니 예약 전 대표에게 한 번 더 확인해 주세요.</p><div class="live-info-cta"><a href="https://nightmens.com/play/live" class="live-info-link" target="_blank" rel="noopener noreferrer">유앤미출근부·엔트리·초이스톡 보러가기</a></div><div class="live-info-grid" aria-label="유앤미 실시간 룸 및 엔트리 정보"><article class="live-card live-room-card"><div class="live-card-head"><div><p class="live-card-label">Room</p><h3>룸·웨이팅 현황</h3></div><span class="live-pill" id="live-room-updated">업데이트 확인 중</span></div><div class="live-metrics"><div class="live-metric"><span class="live-metric-value" id="live-room-count">-</span><span class="live-metric-label">이용 가능 룸</span></div><div class="live-metric"><span class="live-metric-value" id="live-wait-count">-</span><span class="live-metric-label">웨이팅</span></div></div><div class="room-detail-list" id="live-room-detail"><p class="live-empty">룸 상세 정보를 불러오는 중입니다.</p></div></article><article class="live-card live-entry-card"><div class="live-card-head"><div><p class="live-card-label">Entry</p><h3>오늘 엔트리</h3></div><span class="live-pill" id="live-entry-count">집계 중</span></div><div class="entry-list" id="live-entry-list"><p class="live-empty">엔트리 정보를 불러오는 중입니다.</p></div></article></div></div>`}})}
function Pb(){const s=[{name:"유앤미 입구",desc:"입구"},{name:"유앤미 룸 1",desc:"ROOM 1"},{name:"유앤미 룸 2",desc:"ROOM 2"},{name:"유앤미 룸 3",desc:"ROOM 3"}];return f.jsxs(f.Fragment,{children:[f.jsxs("div",{"data-loc":"client/src/pages/Home.tsx:770",className:"relative w-full overflow-hidden",style:{height:"380px"},children:[f.jsx("video",{"data-loc":"client/src/pages/Home.tsx:771",className:"absolute inset-0 w-full h-full object-cover",src:"/manus-storage/facility_banner_277deb8c.mp4",autoPlay:!0,loop:!0,muted:!0,playsInline:!0 }),
