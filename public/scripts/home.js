...
function e2Community(){return f.jsx("section",{className:"youandme-signal-wrap reviews",id:"community-reviews","aria-labelledby":"community-reviews-h2",dangerouslySetInnerHTML:{__html:`<div class="signal-inner"><p class="section-label">Midnightmens Reviews</p><h2 id="community-reviews-h2">유앤미 키워드 후기 검색결과</h2><p class="section-desc">미드나잇맨즈 후기글에서 유앤미, 유엔미, ㅇㅇㅁ 키워드 검색 결과를 모아 보여줍니다.</p><div class="community-review-status" id="community-review-status">커뮤니티 후기를 불러오는 중입니다.</div><div class="review-grid" id="community-review-list"></div></div>`}})}
